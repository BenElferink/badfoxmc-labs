...
const StakePools = (props: {
  ...
  const { defaultData, callback, next, back, noHolders } = props
  const [formData, setFormData] = useState({
    ...defaultData,
    withDelegators: defaultData.withDelegators || noHolders || false,
    stakePools: defaultData.stakePools || noHolders ? [''] : [],
  })
  ...
  return (
    <JourneyStepWrapper
      ...
      back={back}
    >
      <h6 className='text-xl text-center'>{noHolders ? 'What are your stake pools?' : 'Should holders be delegating?'}</h6>
