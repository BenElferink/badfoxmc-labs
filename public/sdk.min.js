class BadLabsSDK {
  ...
  loadWallets = async (e) => {
    let { injectId: t, buttonBackgroundColor: r = '#f5f5f5', buttonTextColor: i = '#00000' } = e || {}
    ...
    s.forEach((e) => {
      ...
      ;(s.style = `width: 150px; height: 2.5rem; margin: 0.1rem; white-space: nowrap; color: ${i}; background-color: ${r}; border: none; border-radius: 0.5rem;`),
        s.appendChild(t),
        s.appendChild(a),
        (s.onclick = async () => {
  ...
  start({ userStakeKey: e } = {}) {
    ...
    ;(this.iFrameWrapper = document.createElement('div')),
      ...
      this.iFrame.setAttribute(
        'style',
        `max-width: ${i ? '100vw' : '555px'}; width: 100%; max-height: ${i ? '100vh' : '70vh'}; height: 100%; border: none; border-radius: ${
          i ? '0' : '1rem'
